use super::{MENU_GRID, Menu, MenuTile, assets::MenuAssets};

use sdl2::{pixels::Color, rect::{Point, Rect}, render::WindowCanvas};

pub fn render(menu: &Menu, canvas: &mut WindowCanvas, assets: &MenuAssets) {
...
fn draw_tile(canvas: &mut WindowCanvas, tile: &MenuTile, selected: bool, assets: &MenuAssets) {
